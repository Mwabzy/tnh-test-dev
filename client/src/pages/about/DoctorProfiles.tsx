...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    servicesOffered: [
      ...
      "Acute care for Paediatric patients",
      "Immunization",
    ],
    socialMediaWebsite: [],
  },
  ...
  },
  {
    ...
    awardsAndRecognition: [],
    ResearchAndPublications: [],
    servicesOffered: ["Consultations", "Diagnostic evaluation", "Surgeries"],
    socialMediaWebsite: [],
  },
  {
    ...
    servicesOffered: [
      "Consultation",
      "Obstetric procedures and surgeries",
      "Gynaecological procedures and surgeries",
    ],
  ...
  },
  {
    ...
    servicesOffered: [
      "Advanced airway placement and mechanical ventilation",
      "Insertion of central venous catheters",
      "Point of Care ultrasound (POCUS)",
      "Evacuation of the critically ill",
      "Incident command and mass triage in acute trauma",
      "Acute pain management",
      "Regional and general anaesthesia provision",
    ],
    socialMediaWebsite: [],
  },
  {
    ...
    servicesOffered: [
      "Routine paediatric consultation",
      "Well baby check-up",
  ...
  },
  {
    ...
    servicesOffered: [
      ...
      "Training on research and publication",
    ],
    socialMediaWebsite: [
      "LinkedIn: Paul Koigi",
  ...
  },
  {
    ...
    servicesOffered: [
      "Surgical outpatient and inpatient consultations",
      "Trauma care and resuscitations",
  ...
  },
  {
    ...
    servicesOffered: ["Anatomical Pathology", "Clinical Pathology"],
    socialMediaWebsite: [],
  },
  {
  ...
  },
  {
    ...
    servicesOffered: ["Hip Arthroplasty", "Knee Arthroplasty"],
