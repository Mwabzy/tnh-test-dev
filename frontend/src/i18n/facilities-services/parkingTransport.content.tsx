...
export type ParkingTransportContent = {
  pageTitle: string;
  ...
  physicalAddressTitle: string;
  physicalAddressList: string[];
  nearbyLandmarksTitle: string;
  nearbyLandmarksList: string[];
  publicTransportTitle: string;
  publicTransportDescription: string;
  publicTransportList: { label: string; text: string }[];
};

const parkingTransport: Dictionary<ParkingTransportContent> = {
  ...
  content: {
      ...
      table: [
        {
          duration: t({
            en: "First 30 minutes",
            fr: "30 premières minutes",
            es: "Primeros 30 minutos",
            zh: "前30分钟",
            ru: "Первые 30 минут",
          }),
          cost: t({
    ...
    physicalAddressList: [
      t({
        ...
        fr: "Hôpital de Nairobi",
        es: "Hospital de Nairobi",
        zh: "内罗毕医院",
        ru: "Больница Найроби",
      }),
      t({
        en: "Argwings Kodhek Road, Nairobi, Kenya",
        fr: "Route Argwings Kodhek, Nairobi, Kenya",
        es: "Argwings Kodhek Road, Nairobi, Kenia",
        zh: "肯尼亚内罗毕Argwings Kodhek路",
        ru: "Аргвингс Кодхек Роуд, Найроби, Кения",
      }),
    ],
    ...
    nearbyLandmarksList: [
      t({
        en: "Opposite Hurlingham Shopping Centre",
        fr: "En face du centre commercial Hurlingham",
        es: "Frente al Hurlingham Shopping Centre",
        zh: "赫林汉姆购物中心对面",
        ru: "Напротив торгового центра Херлингем",
      }),
      t({
        en: "Near Upper Hill Business District",
        fr: "Près du quartier des affaires d'Upper Hill",
        es: "Cerca del distrito comercial Upper Hill",
        zh: "靠近上城区商务区",
        ru: "Рядом с деловым районом Аппер Хилл",
      }),
    ],
    ...
    publicTransportList: [
      {
        label: t({
          ...
          es: "Rutas de autobús:",
          zh: "公交路线：",
          ru: "Маршруты автобусов:",
        }),
        text: t({
          en: "Several buses operate along Argwings Kodhek Road and Valley Road.",
          fr: "Plusieurs bus circulent le long de Argwings Kodhek Road et Valley Road.",
          es: "Varios autobuses operan a lo largo de Argwings Kodhek Road y Valley Road.",
          zh: "多路公交沿Argwings Kodhek路和Valley路运行。",
          ru: "По Argwings Kodhek Road и Valley Road курсируют несколько автобусов.",
        }),
      },
      {
        label: t({
          en: "Nearest Bus Stop:",
          fr: "Arrêt de bus le plus proche :",
          es: "Parada de autobús más cercana:",
          zh: "最近的公交站：",
          ru: "Ближайшая автобусная остановка:",
        }),
        text: t({
          en: "Nairobi Hospital Stage (5-minute walk).",
          fr: "Nairobi Hospital Stage (5 minutes à pied).",
          es: "Nairobi Hospital Stage (5 minutos a pie).",
          zh: "内罗毕医院站（步行5分钟）。",
          ru: "Стадия больницы Найроби (5 минут пешком).",
        }),
      },
      {
        label: t({
        ...
        text: t({
          en: "Available from CBD routes heading toward Hurlingham and Upper Hill.",
          fr: "Disponible depuis les lignes du centre-ville en direction de Hurlingham et Upper Hill.",
          es: "Disponible desde rutas del CBD hacia Hurlingham y Upper Hill.",
          zh: "从中央商务区线路可前往赫林汉姆和上城区。",
      ...
      },
      {
        ...
        text: t({
          en: "Nearest railway access is Nairobi Central Station (approx. 15–20 min by taxi).",
          fr: "L'accès ferroviaire le plus proche est Nairobi Central Station (environ 15 à 20 minutes en taxi).",
          es: "El acceso ferroviario más cercano es Nairobi Central Station (aprox. 15–20 min en taxi).",
          zh: "最近的铁路是内罗毕中央车站（乘出租车约15–20分钟）。",
          ru: "Ближайший железнодорожный доступ — станция Найроби Центральная (примерно 15–20 мин на такси).",
        }),
      },
    ],
  },
