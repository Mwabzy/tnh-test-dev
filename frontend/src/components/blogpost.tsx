      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 auto-rows-[250px] gap-6">
            ...
            <div className="md:col-span-2 md:row-span-2 relative rounded-lg overflow-hidden group">
              ...
              <div className="relative h-full   flex flex-col justify-end p-6  text-white">
                ...
                <div className="bg-gray-100 border-1 border-red-900  text-red-900 max-w-full bg-opacity-70 p-4 rounded-2xl">
                  ...
                  <p className="text-black text-sm hidden sm:block mb-4">
          ...
          {otherPosts.map((post, index) => (
            <div
              key={post.id}
              className={`bg-gray-50/80 p-6 rounded-lg flex flex-col justify-between border-1 border-red-900  hover:shadow-xl transition-shadow duration-300 ${
            ...
            >
              ...
              <Link
                to={`/blog/${post.id}`}
                className="text-red-900 font-semibold mt-4 inline-flex items-center group"
              >
                Read More
                <svg
