...
const AccidentEmergencyServices: React.FC = () => {
  const emergencyCategories = [
    ...
    },
    {
      ...
      conditions: ['Moderate Pain', 'Mild Trauma', 'Dehydration', 'Minor Burns'],
    },
  ];
  ...
  const testimonials = [
    {
      id: 't1',
      quote: 'The A&E team responded incredibly fast when my son had a severe allergic reaction. Professional and reassuring throughout.',
      name: 'Sarah M., Karen',
      avatar: '/src/assets/images/image1.png',
    },
    {
      id: 't2',
      quote: 'Excellent trauma care after my accident. The team worked seamlessly together and kept my family informed.',
      name: 'James O., Westlands',
      avatar: '/src/assets/doctorsImages/jorammugo.png',
    },
    {
      id: 't3',
      quote: 'Quick, efficient service for what could have been a very stressful situation. Thank you TNH A&E!',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-red-900 text-white py-2">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <a href="tel:0703082640"                 className="flex items-center gap-2 bg-yellow-600 text-white px-4 py-1 rounded-full font-bold hover:bg-yellow-500 transition-colors shadow-md">
            0703 082 640
          </a>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 -mt-10 relative z-10">
        ...
        <div className="max-w-7xl mx-auto mb-12 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="order-2 lg:order-1">
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h2 className="text-3xl font-serif font-bold text-red-900 mb-4">World-Class Emergency Care</h2>
              <p className="text-gray-600 mb-4">The Nairobi Hospital's Accident & Emergency Department provides comprehensive emergency medical care 24 hours a day, 365 days a year. Our team of emergency medicine specialists, trauma surgeons, and critical care nurses ensures immediate response to any medical emergency.</p>
        ...
        <div className="max-w-7xl mx-auto mb-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-4">
              <p className="text-sm opacity-90">Our emergency department is ready 24/7 for immediate care</p>
              <a href="tel:0703082640" className="inline-block bg-yellow-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-yellow-500 transition-colors shadow-lg">
                Call Emergency Now
              </a>
            </div>
          </div>          <div className="bg-red-50 rounded-xl p-6 shadow-sm flex flex-col justify-between hover:shadow-lg transition-shadow">
            <h3 className="text-lg font-semibold text-red-900">Find Us</h3>
            <div>
              <p className="text-sm text-gray-600 mb-3">Argwings Kodhek Road, Nairobi</p>
              <a href="/directions" className="inline-flex items-center text-yellow-600 text-sm hover:text-yellow-500">
                Get Directions
          ...
          <div className="bg-red-50 rounded-xl p-6 shadow-sm flex flex-col justify-between hover:shadow-lg transition-shadow">
            ...
            <div>
              <p className="text-sm text-gray-600 mb-3">We accept all major insurance</p>
              <a href="/insurance" className="inline-flex items-center text-yellow-600 text-sm hover:text-yellow-500">
                Learn More
                <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
        ...
        <div className="max-w-7xl mx-auto mb-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-600 mb-2">Our triage system ensures the most urgent cases are seen first:</p>
            <ul className="list-disc pl-5 text-gray-600 space-y-2">
        ...
        <div className="max-w-7xl mx-auto mb-12 space-y-6">
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-600">24/7 emergency ambulance service with advanced life support capabilities. Our ambulances are equipped with the latest medical technology and staffed by experienced paramedics.</p>
          </div>

          <div className="bg-white rounded-xl p-6 shadow-sm grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <h4 className="font-semibold text-lg mb-2">Emergency Facilities</h4>
              <ul className="list-disc pl-5 text-gray-600 space-y-2">
            ...
            <div>
              ...
              <p className="text-gray-600">A&E entrance on Argwings Kodhek Road. Dedicated ambulance bay and separate walk-in entrance. Reserved parking for emergency cases. Security-controlled access 24/7.</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto mb-20">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-serif font-bold text-red-900 mb-2">Patient Stories</h3>
