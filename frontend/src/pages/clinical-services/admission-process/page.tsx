              ...
              <div className="lg:col-span-7">
                ...
                >
                  ...
                  <p className="text-gray-700 max-w-2xl leading-relaxed mb-6">
                    ...
                    and stress-free experience. Our dedicated admission team is
                    here to guide you through each step and answer any questions
                    you may have.
                  </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li>
                    confirm whether your specific insurance plan is accepted.
                  </li>
                </ul>
              </motion.div>
              <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                a: "General visiting hours are from 12:00 PM to 1:00 PM and 4:00 PM to 6:00 PM daily.",
              },
            ].map((faq, idx) => (
              <motion.div
                key={idx}
