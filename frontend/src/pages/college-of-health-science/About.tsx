...
export default function AboutCollege() {
  const content = useIntlayer("aboutCollege");
  ...
  return (
    <>
      <Heading
        ...
        title={content.about?.[0]?.value}
        description={content.aboutDescription?.[0]?.value}
        style="image"
      />
      ...
      <div className="bg-white py-9 px-4 mx-[10%] md:px-10 lg:px-24">
        ...
        <div className="space-y-12">
          {Array.isArray(content.historyTimeline) &&
            (content.historyTimeline as HistoryTimelineItem[]).map(
              (item, index) => (
                <div
                  key={index}
