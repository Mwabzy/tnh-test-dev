        ...
        {activeTab === "basic" && (
          <div>
            <div className="flex flex-col md:flex-row items-start gap-6 mb-8">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-sm text-gray-700 mb-4">
                  ...
                  training in nursing practice, preparing students for
                  registration as nurses in Kenya. The program combines
                  theoretical knowledge with practical experience in diverse
                  healthcare settings.
                </p>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                Such a candidate will be assessed for English language
                proficiency through oral interviews held via a medium that is
                convenient and reliable.
              </li>
              <li>
                Must be approved/cleared by the Nursing Council of Kenya to join
                a training program in Kenya.
              </li>
              <li>
        ...
        {activeTab === "post" && (
          <div>
            <div className="flex flex-col md:flex-row items-start gap-6 mb-8">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-sm text-gray-700 mb-4">
                  ...
                  nurses seeking to advance their skills in specialized areas
                  such as oncology, neonatal, perioperative, trauma and
                  emergency nursing. These programs combine advanced clinical
            ...
            <ul className="list-disc pl-5 text-md text-gray-800">
              <li>
                Online teaching was adopted during the pandemic to ensure
                learning continuity while the colleges were closed.
              </li>
              <li>
