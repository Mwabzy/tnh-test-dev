    ...
    <section className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid gap-20  md:grid-cols-3 text-center">
          {/* Card 1 */}
          <div className="flex flex-col items-center space-y-2 shadow-xl p-6 md:p-6 cursor-pointer hover:shadow-2xl transition-shadow duration-300 ease-in-out"
          ...
          <div className="flex flex-col items-center space-y-2 shadow-xl p-6">
            ...
            <p className="mt-2">
              {" "}
              Registering as a patient is the first step toward accessing
              personalized, quality healthcare.{" "}
            </p>
          </div>

          {/* Card 3 */}
          <div className="flex flex-col items-center space-y-2 shadow-xl p-6 cursor-pointer hover:shadow-2xl transition-shadow duration-300 ease-in-out"
